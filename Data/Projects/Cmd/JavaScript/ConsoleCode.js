    ...
    outputLine(input);
     switch(input.toLowerCase()) {
         ...
         case "cv":
             ...
             break;
         case "github":
             website("https://github.com/Kney-Delach", "Github");
             break;
         case "youtube":
             website("https://www.youtube.com/", "YouTube");
             break;
         case "twitch":
             website("https://www.twitch.tv/", "Twitch");
             break;
         case "facebook":
         ...
         case "reddit":
             ...
             break;
		 case "bookmarks":
             website("http://www.orilazar.com", "homepage");
             break;
		 case "projects":
             projectList();
             break;
